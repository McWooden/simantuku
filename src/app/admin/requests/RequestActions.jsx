    ...
    <div className="flex flex-wrap items-center justify-end gap-2 relative">
      {isManagerOrAdmin ? (
        <div ref={dropdownRef} className="relative inline-block text-left">
            ...
            return (
              ...
              >
                <Button
                  ...
                  onClick={() => !isDropdownButtonLocked && setIsDropdownOpen(!isDropdownOpen)}
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-1.5 z-50 w-60 rounded-xl border border-slate-200 bg-white p-1.5 shadow-lg animate-in fade-in-50 slide-in-from-top-1 duration-150">
