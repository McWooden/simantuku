  ...
  if (error || !request) {
    return (
      <div className="container mx-auto p-6 text-center">
        ...
        <p className="mt-2 text-slate-500">Data cuti mungkin telah dihapus atau ID tidak valid.</p>
  ...
  return (
    <div className="container mx-auto p-4 md:p-8 max-w-4xl space-y-6">
      ...
      {request.attachment_url && (
        <div className="mt-8 space-y-4">
          <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
            <FileText className="w-5 h-5 text-primary" /> Pratinjau Lampiran
          </h2>
          <div className="w-full h-[800px] border border-slate-200 rounded-lg overflow-hidden bg-white shadow-sm">
            <iframe 
              src={`${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/leave_attachments/${request.attachment_url}#toolbar=0`} 
